#--------- Flask settings
SERVER_HOST = 'https://testbermelm.azurewebsites.net/' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://bermelmneighborlyfunction.azurewebsites.net/api"
